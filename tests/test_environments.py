...
class TestEnvironment(unittest.TestCase):
  ...
  def test_perceiving_the_board(self):
    ...
    self.assertEqual([piece_c, piece_b, piece_a], percept.upcoming_pieces)
    percept = env.perceive()
    self.assertIsInstance(percept, Percept)
    self.assertEqual(piece_c, percept.piece)
    self.assertEqual([piece_b, piece_a], percept.upcoming_pieces)
    percept = env.perceive()
    self.assertIsInstance(percept, Percept)
    self.assertEqual(piece_b, percept.piece)
    self.assertEqual([piece_a], percept.upcoming_pieces)
    percept = env.perceive()
    self.assertIsInstance(percept, Percept)
    self.assertEqual(piece_a, percept.piece)
    self.assertEqual([], percept.upcoming_pieces)
